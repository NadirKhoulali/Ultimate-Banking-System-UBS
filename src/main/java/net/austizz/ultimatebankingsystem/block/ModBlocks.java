...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> TALL_WALL_SHELF = registerBlock("tall_wall_shelf",
    ...
    public static final RegistryObject<Block> SHOP_SHELF = registerBlock("shop_shelf",
            () -> new TallWallShelfBlock(
                    BlockBehaviour.Properties.of()
                            .noOcclusion()
                            // Shelf is intentionally non-minable; removal is via Shelf UI action only.
    ...
    public static final RegistryObject<Block> SHOPPING_BAG = registerBlock("shopping_bag",
            () -> new ShoppingBagBlock(BlockBehaviour.Properties.of()
                    .noOcclusion()
                    .strength(1.0f)
                    .sound(SoundType.WOOL)
            ));
    public static final RegistryObject<Block> SHOPPING_BASKET_HOLDER = registerBlock("shopping_basket_holder",
            () -> new ShoppingBasketHolderBlock(BlockBehaviour.Properties.of()
                    .noOcclusion()
                    .strength(2.0f)
                    .sound(SoundType.METAL)
            ));
    public static final RegistryObject<Block> SHOP_SELLING_TABLE = registerBlock("shop_selling_table",
    ...
    public static final RegistryObject<Block> CREATIVE_SHOP_SELLING_TABLE = registerBlock("creative_shop_selling_table",
            () -> new ShopSellingTableBlock(
                    BlockBehaviour.Properties.of()
                            .noOcclusion()
                            // Table is intentionally non-minable; removal is via Shelf UI action only.
    ...
    public static final RegistryObject<Block> SHOP_SELLING_TABLE_LARGE = registerBlock("shop_selling_table_large",
    ...
    public static final RegistryObject<Block> CREATIVE_SHOP_SELLING_TABLE_LARGE = registerBlock("creative_shop_selling_table_large",
            () -> new ShopSellingTableLargeBlock(
                    BlockBehaviour.Properties.of()
                            .noOcclusion()
                            // Table is intentionally non-minable; removal is via Shelf UI action only.
    ...
    public static final RegistryObject<Block> INVISIBLE_DISPLAY_SMALL = registerBlock("invisible_display_small",
    ...
    public static final RegistryObject<Block> INVISIBLE_DISPLAY_MEDIUM = registerBlock("invisible_display_medium",
            () -> new InvisibleDisplayBlock(
                    BlockBehaviour.Properties.of()
                            .noOcclusion()
                            // Display is intentionally non-minable; removal is via Shelf UI action only.
    ...
    public static final RegistryObject<Block> INVISIBLE_DISPLAY_LARGE = registerBlock("invisible_display_large",
            () -> new InvisibleDisplayBlock(
                    BlockBehaviour.Properties.of()
                            .noOcclusion()
                            // Display is intentionally non-minable; removal is via Shelf UI action only.
    ...
    public static final RegistryObject<Block> CREATIVE_INVISIBLE_DISPLAY_SMALL = registerBlock("creative_invisible_display_small",
            () -> new InvisibleDisplayBlock(
                    BlockBehaviour.Properties.of()
                            .noOcclusion()
                            // Display is intentionally non-minable; removal is via Shelf UI action only.
    ...
    public static final RegistryObject<Block> CREATIVE_INVISIBLE_DISPLAY_MEDIUM = registerBlock("creative_invisible_display_medium",
            () -> new InvisibleDisplayBlock(
                    BlockBehaviour.Properties.of()
                            .noOcclusion()
                            // Display is intentionally non-minable; removal is via Shelf UI action only.
    ...
    public static final RegistryObject<Block> CREATIVE_INVISIBLE_DISPLAY_LARGE = registerBlock("creative_invisible_display_large",
            () -> new InvisibleDisplayBlock(
                    BlockBehaviour.Properties.of()
                            .noOcclusion()
                            // Display is intentionally non-minable; removal is via Shelf UI action only.
    ...
    public static final RegistryObject<Block> MODULAR_WALL_DISPLAY = registerBlock("modular_wall_display",
    ...
    public static final RegistryObject<Block> CREATIVE_MODULAR_WALL_DISPLAY = registerBlock("creative_modular_wall_display",
            () -> new ModularWallDisplayBlock(
                    BlockBehaviour.Properties.of()
                            .noOcclusion()
                            // Display is intentionally non-minable; removal is via Shelf UI action only.
    ...
    public static final RegistryObject<Block> GLASS_COUNTER_DISPLAY = registerBlock("glass_counter_display",
    ...
    public static final RegistryObject<Block> CREATIVE_GLASS_COUNTER_DISPLAY = registerBlock("creative_glass_counter_display",
            () -> new GlassCounterDisplayBlock(
                    BlockBehaviour.Properties.of()
                            .noOcclusion()
                            // Display is intentionally non-minable; removal is via Shelf UI action only.
    ...
    public static final RegistryObject<Block> GLASS_COUNTER_DISPLAY_OPEN = registerBlock("glass_counter_display_open",
            () -> new GlassCounterDisplayBlock(
                    BlockBehaviour.Properties.of()
                            .noOcclusion()
                            // Display is intentionally non-minable; removal is via Shelf UI action only.
    ...
    public static final RegistryObject<Block> CREATIVE_GLASS_COUNTER_DISPLAY_OPEN = registerBlock("creative_glass_counter_display_open",
            () -> new GlassCounterDisplayBlock(
                    BlockBehaviour.Properties.of()
                            .noOcclusion()
                            // Display is intentionally non-minable; removal is via Shelf UI action only.
