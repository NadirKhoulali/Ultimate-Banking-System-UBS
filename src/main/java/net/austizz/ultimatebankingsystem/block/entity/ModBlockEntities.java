...
public final class ModBlockEntities {
    // Forge 1.20.1 runtime expects block-entity registration through ForgeRegistries.
    // Using this avoids NoSuchFieldError on environments where Registries.BLOCK_ENTITY_TYPE
    // is not available under the mapped runtime.
    public static final DeferredRegister<BlockEntityType<?>> BLOCK_ENTITY_TYPES =
            DeferredRegister.create(ForgeRegistries.BLOCK_ENTITY_TYPES, UltimateBankingSystem.MODID);
    ...
    public static final RegistryObject<BlockEntityType<TallWallShelfBlockEntity>> TALL_WALL_SHELF =
    ...
    public static final RegistryObject<BlockEntityType<ShoppingBasketBlockEntity>> SHOPPING_BASKET =
    ...
    public static final RegistryObject<BlockEntityType<ShoppingBagBlockEntity>> SHOPPING_BAG =
    ...
    public static final RegistryObject<BlockEntityType<ShoppingBasketHolderBlockEntity>> SHOPPING_BASKET_HOLDER =
    ...
    public static final RegistryObject<BlockEntityType<ShopSellingTableBlockEntity>> SHOP_SELLING_TABLE =
    ...
    public static final RegistryObject<BlockEntityType<ModularWallDisplayBlockEntity>> MODULAR_WALL_DISPLAY =
    ...
    public static final RegistryObject<BlockEntityType<GlassCounterDisplayBlockEntity>> GLASS_COUNTER_DISPLAY =
    ...
    public static final RegistryObject<BlockEntityType<CardboardBoxBlockEntity>> CARDBOARD_BOX =
    ...
    public static final RegistryObject<BlockEntityType<PalletBlockEntity>> PALLET =
