...
public class PalletBlockEntity extends net.minecraft.world.level.block.entity.BlockEntity {
    ...
    private LazyOptional<IItemHandler> itemHandlerCapability = LazyOptional.of(() -> boxes);
    ...
    protected void saveAdditional(CompoundTag tag) {
        ...
        tag.put(STORAGE_KEY, boxes.serializeNBT());
    ...
    public void load(CompoundTag tag) {
        ...
        if (tag.contains(STORAGE_KEY)) {
            ...
            boxes.deserializeNBT(storageTag);
        } else {
    ...
    public void reviveCaps() {
        super.reviveCaps();
        itemHandlerCapability = LazyOptional.of(() -> boxes);
    }
