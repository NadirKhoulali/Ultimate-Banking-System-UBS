...
public class PalletRenderer implements BlockEntityRenderer<PalletBlockEntity> {
    ...
    public void render(PalletBlockEntity pallet,
        ...
        if (!state.hasProperty(PalletBlock.PART_X)
        ...
        drawDeliveryLabel(pallet, poseStack, bufferSource, packedLight);
    }
    ...
    private void drawDeliveryLabel(PalletBlockEntity pallet,
        ...
        for (int i = 0; i < lines.size(); i++) {
            ...
            font.drawInBatch(line, x, y, color, false, matrix, bufferSource, Font.DisplayMode.NORMAL, 0, FULL_BRIGHT);
            y += 10.0F;
        }
        poseStack.popPose();
    }
