...
public final class ClientModBusEvents {
    ...
    public static void onClientSetup(FMLClientSetupEvent event) {
        event.enqueueWork(() -> {
            ...
            MenuScreens.register(ModMenus.CARDBOARD_BOX.get(), CardboardBoxScreen::new);
            MenuScreens.register(ModMenus.SHOPPING_BAG.get(), ShoppingBagScreen::new);
            MenuScreens.register(ModMenus.SHOPPING_BAG_ITEM.get(), ShoppingBagScreen::new);
        });
    }
