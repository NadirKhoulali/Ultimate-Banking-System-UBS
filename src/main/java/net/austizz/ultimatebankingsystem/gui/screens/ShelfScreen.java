...
public class ShelfScreen extends Screen {
    ...
    private final SlotLayout[] slotLayouts = new SlotLayout[3];
    ...
    private final DesktopEditBox[] priceInputs = new DesktopEditBox[3];
    private final DesktopButton[] setFromHandButtons = new DesktopButton[3];
    private final DesktopButton[] savePriceButtons = new DesktopButton[3];
    private final DesktopButton[] setStockButtons = new DesktopButton[3];
    private final DesktopButton[] takeStockButtons = new DesktopButton[3];
    private final DesktopButton[] clearSlotButtons = new DesktopButton[3];
    private final DesktopButton[] editPositionButtons = new DesktopButton[3];
    ...
    public ShelfScreen(ShelfOpenPayload payload) {
        super(Component.literal("Shelf Manager"));
    ...
    protected void init() {
        ...
        prevShelfButton = addRenderableWidget(new DesktopButton(contentLeft, controlsY, navWidth, 24,
                Component.literal("Prev Shelf"), 0xFF7BC2FF, btn -> stepShelf(-1)));
        nextShelfButton = addRenderableWidget(new DesktopButton(contentLeft + navWidth + pairGap, controlsY, navWidth, 24,
                Component.literal("Next Shelf"), 0xFF7BC2FF, btn -> stepShelf(1)));
        ...
        removeShelfButton = addRenderableWidget(new DesktopButton(removeX, removeY, removeWidth, 24,
                Component.literal("Remove Selected Shelf"), 0xFFE28787, btn -> submitAction("remove_shelf", -1)));
        ...
        modularLayoutButton = addRenderableWidget(new DesktopButton(
                ...
                layoutWidth,
                24,
                Component.literal(isSelectedModularExpanded() ? "Layout: 4 Items (2x2)" : "Layout: 2 Items (2x1)"),
                0xFF98C7FF,
        ...
        for (int slot = 0; slot < 3; slot++) {
            ...
            DesktopButton setFromHand = addRenderableWidget(new DesktopButton(
                    ...
                    100,
                    24,
                    Component.literal("Set From Inventory"),
                    0xFF8DD9FF,
            ...
            DesktopButton setStock = addRenderableWidget(new DesktopButton(
                    ...
                    100,
                    22,
                    Component.literal("Set Stock"),
                    0xFF8DBEFF,
                    btn -> openInventoryPicker(slotIndex, PickerMode.SET_STOCK)
            ));
            ...
            DesktopButton editPosition = addRenderableWidget(new DesktopButton(
                    ...
                    100,
                    24,
                    Component.literal("Edit Position"),
                    0xFFB8A5F2,
        ...
        modeToggleButton = addRenderableWidget(new DesktopButton(
                ...
                modeWidth,
                22,
                Component.literal(selectedShopMode ? "Mode: Shop" : "Mode: Regular"),
    ...
    private int getVisibleSlotCount() {
        ...
        return Math.max(1, Math.min(3, selected.slots().size()));
    }
    ...
    public void render(GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        graphics.drawString(font, "Shelf Manager", panelLeft + 12, panelTop + 11, 0xFFF6FCFF, false);
        ...
        if (selected != null) {
            ...
            graphics.drawString(font, modeLabel, panelLeft + 14, panelTop + 48, selected.shopMode() ? 0xFFAED8FF : 0xFFC9D8E6, false);
        }
        ...
        if (selected != null) {
            ...
            if (showOwnerLines) {
                ...
                graphics.drawString(font,
                        selected.canManage() ? "Access: Manage" : "Access: View only",
                        accessLineX,
                        accessLineY,
            ...
            for (int slot = 0; slot < 3; slot++) {
                ...
                graphics.drawString(font, shelfLabel, slotBoxX + 28, y + 8, 0xFFE7F5FF, false);
                String itemLine = hasItem
                        ? "Item " + fitText(slotData == null ? slotStack.getHoverName().getString() : slotData.itemName(), Math.max(60, blockRight - (slotBoxX + 34)))
                        : "Item -";
                ...
                if (selectedShopMode) {
                    ...
                    String stock = configured
                            ...
                            : "0";
                    graphics.drawString(font, "Price " + price, slotBoxX + 28, y + 30, 0xFFF7E38A, false);
                    graphics.drawString(font, "Stock " + stock, slotBoxX + 110, y + 30, 0xFFAED8FF, false);
                    graphics.drawString(font, "Price", priceInputs[slot].getX() - 44, priceInputs[slot].getY() - 10, 0xFFC3DAEF, false);
                    graphics.drawString(font, "Stock", layout.stockSlotX - 43, layout.stockSlotY + 6, 0xFFC3DAEF, false);
                    ...
                    graphics.drawString(font, "Regular display (not purchasable)", slotBoxX + 28, y + 30, 0xFFBBD1E7, false);
                }
            }
    ...
    private void renderInventoryPicker(GuiGraphics graphics, int mouseX, int mouseY) {
        ...
        graphics.drawString(font, "Shelf Slot " + (pickerTargetShelfSlot + 1), pickerLeft + 10, pickerTop + 28, 0xFFD0E7FF, false);
        ...
        graphics.drawString(font, "Cancel", pickerCancelX + 26, pickerCancelY + 6, 0xFFFFFFFF, false);
