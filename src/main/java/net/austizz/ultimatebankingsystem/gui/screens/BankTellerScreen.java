...
public class BankTellerScreen extends Screen {
    ...
    public void render(GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        graphics.drawString(font, title, panelLeft + 14, panelTop + 10, 0xFFF3F9FF, false);
    ...
    private void renderHeaderProfile(GuiGraphics graphics, float partialTick) {
        ...
        String selectedLine = getSelectedAccount() == null
                ? "Current Account: None"
                : "Current Account: " + fitToWidth(getSelectedAccount().accountType(), 24);
        graphics.drawString(font, fitToWidth(selectedLine, textW), textX, profileY + 22, 0xFFCFE7FF, false);
        graphics.drawString(font, fitToWidth("Bank: " + safe(payload == null ? "" : payload.boundBankName()), textW),
                textX, profileY + 35, 0xFFAED3F0, false);
